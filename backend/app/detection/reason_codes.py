...
class ReasonCode(str, Enum):
    ...
    INJ_EN_DIRECT_OVERRIDE = "INJ_EN_DIRECT_OVERRIDE"
    INJ_EN_SYSTEM_PROMPT_LEAK = "INJ_EN_SYSTEM_PROMPT_LEAK"
    INJ_EN_POLICY_BYPASS = "INJ_EN_POLICY_BYPASS"
    INJ_EN_JAILBREAK = "INJ_EN_JAILBREAK"
...
_REASON_ACTIONS = {
    ...
    ReasonCode.INJ_EN_DIRECT_OVERRIDE.value: PolicyAction.BLOCK.value,
    ReasonCode.INJ_EN_SYSTEM_PROMPT_LEAK.value: PolicyAction.BLOCK.value,
    ReasonCode.INJ_EN_POLICY_BYPASS.value: PolicyAction.BLOCK.value,
    ReasonCode.INJ_EN_JAILBREAK.value: PolicyAction.BLOCK.value,
