...
DATASET_PATH = PROJECT_ROOT / "evaluation" / "datasets" / "prompt_injection_english_cases.json"
...
def test_english_prompt_injection_cases_follow_expected_policy() -> None:
    for case in _cases():
...
def test_english_safe_security_explanations_are_not_blocked() -> None:
    for case in _cases():
