...
|---|---|---|---|---|---:|---|
| deepset | data/external/attention_tracker/shared_prompt_injection_eval.csv | capstone-selected subset | id,text,label,instruction | injection/attack/jailbreak/unsafe=1; safe/benign/normal=0 | 100 | preserves previous Attention Tracker local reproduction subset |
